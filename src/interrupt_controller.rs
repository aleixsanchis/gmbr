...
impl InterruptController {
    ...
    pub fn get_first_interrupt(&self) -> InterruptFlags{
        if self.iflag & 0b0000_0001 == 0b0000_0001 
            && self.ie & 0b0000_0001 == 0b0000_0001{
            return InterruptFlags::VBlank;
        }
        else if self.iflag & 0b0000_0010 == 0b0000_0010 
            && self.ie & 0b0000_0010 == 0b0000_0010{
            return InterruptFlags::LCDStat;
        }
        else if self.iflag & 0b0000_0100 == 0b0000_0100 
            && self.ie & 0b0000_0100 == 0b0000_0100{
            return InterruptFlags::Timer;
        }
        else if self.iflag & 0b0000_1000 == 0b0000_1000 
            && self.ie & 0b0000_1000 == 0b0000_1000{
            return InterruptFlags::Serial;
        }
        else if self.iflag & 0b0001_0000 == 0b0001_0000 
            && self.ie & 0b0001_0000 == 0b0001_0000{
